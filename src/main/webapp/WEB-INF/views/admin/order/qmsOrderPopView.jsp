...
var defaultColModel = [ //  ####### 설정 #######
	...
	{name:"QMS_REMARK", label:'Remark' , width:353, align:'center', sortable:false, editable:false, formatter:setDefault},
							...
							<div class="topSearch">
								...
								<ul>
									...
									<li class="wide"><label class="search-h">자격번호</label>
										<div class="search-c">
										<span id="supvsQlfNo_${mastlist.QMS_SEQ}">${mastlist.SUPVS_QLF_NO}</span>
										</div></li>
									<li class="wide"><label class="search-h">신고번호</label>
										<div class="search-c">
										<span id="supvsDecNo_${mastlist.QMS_SEQ}">${mastlist.SUPVS_DEC_NO}</span>
										</div></li>
									<li><label class="search-h">전화번호</label>
										<div class="search-c">
