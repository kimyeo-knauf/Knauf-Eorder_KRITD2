									...
									<div class="topSearch">
										<ul>
											...
											<li>
												...
												<div id="rFileDivId" class="search-c" ><!-- style="display:none" -->
													<c:if test="${!empty boardOne.BD_FILE}">
														<a href="javascript:;" onclick="fileDown('${boardOne.BD_FILE}','${boardOne.BD_FILETYPE}')"><img src="/eorder/data/board/${boardOne.BD_FILE}" width="25" height="25" onerror="this.src='${url}/include/images/admin/list_noimg.gif'">
																${boardOne.BD_FILE}
														</a>
													</c:if>
												</div>
