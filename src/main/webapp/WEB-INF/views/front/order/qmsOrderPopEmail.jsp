...
function getGridList(){ 
	...
	$("#gridList").jqGrid({
		url: "${url}/front/order/getQmsPopEmailGridList.lime",
	...
	if (confirm('이메일을 발송 하시겠습니까?')) {
		...
		for(var i = 0; i < selRows.length; i++) {
			...
			$.ajax({
				...
				data  : saveRow,
				type  : 'POST',
				url   : '${url}/front/order/setQmsMailLog.lime',
...
<body>
	...
	<div class="qmsBtnDiv row">
		<button class="btn btn-md btn-warning" onclick="javascript:emailSend();" type="button" title="메일 발송">메일 발송</button>
