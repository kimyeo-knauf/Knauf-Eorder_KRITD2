...
function boardViewPop(obj, bdSeq , bdNum){
	...
	if(!isApp()){
		...
		window.open('', 'sampleViewPop', options);
		$('form[name="frmPop"]').prop('action', '${url}/front/board/sampleViewPop.lime');
		console.log(frmPop);
		...
		var link = '${url}/front/board/sampleViewPop.lime?r_bdseq='+bdSeq+'&layer_pop=Y&';
		// 부모창refresh
...
function pager(curpage) {
	...
	formPostSubmit('', '${url}/front/board/sampleList.lime');
}
 ...
 */
 function sampleAddEditPop(obj, bdSeq){		
	...
	console.log("sampleAddEditPop 프론트");
	console.log(bdSeq);
	// POST 팝업 열기.
	...
	$frmPopSubmit.attr('action', '${url}/front/board/sample/pop/addEditPop.lime');
...
<div id="subWrap" class="subWrap">
	...
	<%-- 팝업 전송 form --%>
	<form name="frmPop" method="post" target="sampleViewPop">
	...
	<div class="container-fluid">
		<div class="full-content">
			...
			<div class="row no-m">
				<div class="page-breadcrumb"><strong>샘플요청</strong></div>
...
<%--								<button type="button" class="btn-excel"><img src="${url}/include/images/front/common//icon_excel@2x.png" alt="img" /></button>--%>
									    <button class="btn btn-info" onclick="sampleAddEditPop(this, '');" type="button" title="sample등록">샘플 요청</button>
